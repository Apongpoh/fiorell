    ...
    switch (type) {
      case "daily":
        return {
          title: "Daily Boost",
          description:
            "24-hour profile boost - Be one of the top profiles in your area",
          duration: "24 hours",
                ...
                <div className="text-center p-4">
                  ...
                  {boostStatus.expiresAt && (
                    <p className="text-xs opacity-75 mt-1">
                      Expires:{" "}
                      {new Date(boostStatus.expiresAt).toLocaleString()}
                    </p>
                  )}
                </div>
              </Card>
                  ...
                  >
                    ...
                    {type === "daily" && boostStatus && (
                      <div className="text-xs text-gray-500 dark:text-gray-500 mb-3">
                        Daily boosts used: {boostStatus.dailyBoostsUsed} /{" "}
                        {boostStatus.dailyBoostsLimit}
                      </div>
                    )}

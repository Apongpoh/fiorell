  ...
  const onSubmit = async (data: LoginForm) => {
    try {
      ...
      if (
        ...
        "requiresTwoFA" in result &&
        result.requiresTwoFA
      ) {
      ...
      if (typeof error === "object" && error !== null) {
        ...
        if (
          errObj.response?.requiresVerification ||
          errObj.requiresVerification
        ) {
          const email = errObj.response?.email || errObj.email;
          if (email) {
          ...
          >
            ...
            <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
              ...
              <div className="grid grid-cols-2 gap-3">
                <button
                  type="button"
                  className="flex justify-center items-center px-4 py-2 border border-gray-300 rounded-lg text-sm font-medium text-gray-700 bg-white hover:bg-gray-50 transition-colors"
                >

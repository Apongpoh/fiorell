        ...
        <div className="max-w-5xl mx-auto">
          <FadeIn className="mb-12 text-center">
            ...
            <p className="text-gray-600 text-lg max-w-3xl mx-auto leading-relaxed">
              ...
              collect, how we use it, and the rights you have regarding your
              personal information when using Fiorell.
            </p>
          </FadeIn>
          ...
          <div className="space-y-14">
            ...
            >
              ...
              <p className="text-gray-600 leading-relaxed">
                This Privacy Policy applies to the Fiorell platform (the
                &quot;Service&quot;). By creating an account or using the
                Service you acknowledge the practices described here. If you
                disagree with this Policy, please discontinue use.
              </p>
            </FadeIn>
            ...
            >
              ...
              <ul className="list-disc pl-6 space-y-2 text-gray-600 mb-6">
                <li>
                  Account details (name, email, age, gender, location,
                  biography, interests).
                </li>
                <li>Photos, media uploads, and profile preferences.</li>
                <li>Messages and interactions with other users.</li>
                <li>
                  Subscription & transactional data (via payment processors).
                </li>
              </ul>
              <p className="text-gray-600 leading-relaxed mb-4 font-medium">
              ...
              <ul className="list-disc pl-6 space-y-2 text-gray-600 mb-6">
                <li>
                  Device & usage data (app version, browser, OS, timestamps).
                </li>
            ...
            >
              ...
              <ul className="list-disc pl-6 space-y-2 text-gray-600">
                <li>
                  Provide, personalize, and improve the Service & match
                  relevance.
                </li>
                <li>Enable messaging, interactions, and social discovery.</li>
                <li>Process subscriptions, purchases, and manage billing.</li>
                <li>
                  Detect, prevent, and respond to fraud, abuse, or safety risks.
                </li>
                <li>
                  Send important notices (security alerts, account updates).
                </li>
            ...
            >
              <SectionHeader
                icon={UserCheck}
                title="4. Legal Bases (EEA/UK/Similar Jurisdictions)"
              />
              <ul className="list-disc pl-6 space-y-2 text-gray-600">
                <li>
                  Consent (e.g., certain optional profile data, marketing).
                </li>
                <li>Contract (providing the Service you request).</li>
                <li>
                  Legitimate interests (improving safety, preventing abuse,
                  product development) balanced with your rights.
                </li>
                <li>Legal obligations (tax, accounting, compliance).</li>
                <li>
                  Protection of vital interests or public interest when
                  required.
                </li>
              </ul>
            </FadeIn>
            ...
            >
              ...
              <p className="text-gray-600 leading-relaxed mb-4">
                We use essential cookies for authentication and core
                functionality. We may also use performance and preference
                cookies to remember settings and improve stability. Where
                required, we seek consent for non-essential cookies.
              </p>
              <p className="text-gray-600 leading-relaxed">
                You can adjust browser settings to refuse or delete cookies;
            ...
            >
              ...
              <ul className="list-disc pl-6 space-y-2 text-gray-600 mb-4">
                <li>
                  With other users (public/profile info and matches you engage
                  with).
                </li>
                <li>
                  Service providers (hosting, analytics, content moderation,
                  payment processing) under contractual safeguards.
                </li>
                <li>
                  For legal compliance (lawful requests, enforcement of rights,
                  preventing harm).
                </li>
                <li>
                  During business transfers (merger, acquisition, restructuring)
                  with appropriate safeguards.
                </li>
              </ul>
              <p className="text-gray-600 leading-relaxed">
                We do not sell personal data. We may share aggregated or
            ...
            >
              ...
              <p className="text-gray-600 leading-relaxed">
                ...
                jurisdiction, including where our infrastructure or vendors
                operate. We implement safeguards (e.g., Standard Contractual
                Clauses) where applicable to protect transferred data.
              </p>
            </FadeIn>
            ...
            >
              ...
              <p className="text-gray-600 leading-relaxed mb-4">
                ...
                purposes outlined in this Policy (e.g., account life cycle,
                legal obligations, dispute resolution). Inactive accounts may be
                archived or anonymized after a defined dormancy period.
              </p>
              <p className="text-gray-600 leading-relaxed">
                You may request deletion; certain data (transactional, security
                logs) may be retained as required by law or legitimate
                interests.
              </p>
            </FadeIn>
            ...
            >
              ...
              <p className="text-gray-600 leading-relaxed mb-4">
                ...
                correct, delete, restrict, or object to processing; to
                portability; and to withdraw consent. You also have the right to
            ...
            >
              ...
              <p className="text-gray-600 leading-relaxed">
                We use safeguards such as encryption in transit, access
                controls, monitoring, and layered infrastructure security. No
                system is perfectly secure; users should exercise caution in
            ...
            >
              ...
              <p className="text-gray-600 leading-relaxed">
                ...
                knowingly collect data from minors. If we learn a minor has
                provided personal data, we will take steps to delete it. Report
                concerns to support promptly.
              </p>
            </FadeIn>
            ...
            >
              ...
              <p className="text-gray-600 leading-relaxed">
                ...
                notified via in-app notice or email. Continued use after changes
            ...
            >
              ...
              <p className="text-gray-600 leading-relaxed">
                For data subject rights, include: (a) account email, (b) request
                type, and (c) country/region of residence.
              </p>
            </FadeIn>
          </div>
